          ...
          <div className="mb-8 text-center">
            <div className="flex justify-center mb-4">
              <div className="h-16 w-16 rounded-full bg-one-way-blue-light flex items-center justify-center">
                <Users className="h-8 w-8 text-one-way-blue" />
              </div>
            </div>
            <h1 className="text-4xl font-bold font-serif mb-4">Juventude</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Conteúdos relevantes para jovens cristãos: discipulado, vida espiritual, desafios contemporâneos e muito mais.
            </p>
          </div>
